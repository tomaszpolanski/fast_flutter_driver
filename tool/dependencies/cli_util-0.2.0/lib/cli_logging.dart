...
abstract class Logger {
  ...
  factory Logger.standard({required Ansi ansi}) =>
      new StandardLogger(ansi: ansi);
...
class StandardLogger implements Logger {
  ...
  StandardLogger({required this.ansi}) {
...
class AnsiProgress extends Progress {
  ...
  void finish({String? message, bool? showTiming}) {
    if (_timer.isActive) {
      _timer.cancel();
      _updateDisplay(
          isFinal: true, message: message, showTiming: showTiming ?? false);
    }
  }
...
class VerboseLogger implements Logger {
  ...
  VerboseLogger({required this.ansi, required this.logTime}) {
    ansi = new Ansi(Ansi.terminalSupportsAnsi);
    logTime = false;
